;;;; Tutorial 02: Getting an Image on the Screen
...
(defun main (&aux (path (namestring (asdf:system-relative-pathname :sdl2-tutorials "tutorial-02/assets/")))
	       (title "Tutorial 02: Getting an Image on the Screen") (width 640) (height 480))
  ...
  (sdl2:make-this-thread-main
   (lambda ()
	 ...
	 (let ((surface (sdl2:get-window-surface window))
	       (image (load-media path "hello_world.bmp")))
